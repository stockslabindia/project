...
export const CHAT_SCRIPT = {
  main_menu: {
    id: 'main_menu',
    message: 'Hey {name}, check below options to proceed',
    options: [
      ...
      { label: 'Others',               next: 'connect_agent' },
    ],
  },

  deposit_menu: {
    id: 'deposit_menu',
    message: 'Deposit Issue\n\nPlease select the type of issue:',
    options: [
      { label: 'Paid amount not added',                next: 'connect_agent', topic: 'Deposit > Paid amount not added' },
      { label: 'Paid amount is different from requested amount', next: 'connect_agent', topic: 'Deposit > Amount mismatch' },
      { label: 'Paid on Old UPI Id / Old QR',          next: 'connect_agent', topic: 'Deposit > Old UPI/QR' },
