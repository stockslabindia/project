...
export default function SupportChat() {
  ...
  return (
    <div className="flex flex-col h-full min-h-screen bg-background">
      ...
      {!chatView && (
        <header className="sticky top-0 z-30 bg-primary safe-top">
      ...
      {chatView && (
        <header className="sticky top-0 z-30 bg-primary safe-top shadow-sm">
          <div className="max-w-lg mx-auto flex items-center gap-3 px-3 py-3">
            <button
              onClick={() => {
            ...
            {sessionStatus === 'active' ? (
              <div className="flex items-end gap-2">
                <input
                  ...
                  className="flex-1 bg-surface border border-border/40 rounded-xl px-4 py-2.5 text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all"
                />
                <button
                  onClick={sendMessage}
